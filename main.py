...
def attack(char_name: str, char_class: str) -> str:
    """Выводит результат о проведенной атаке
    в соответствии с выбранным классом персонажа.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит результат о проведенной защите
    в соответствии с выбранным классом персонажа.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит результат о проведенном спецумении
    в соответствии с выбранным классом персонажа.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает функцию, проводящую тренировку
    после выбора класса персонажа.
    """
    if char_class == 'warrior':
...
def main() -> None:
    ...
    приветственное сообщение и начальное меню.
    """
    run_screensaver()
